...
apiRouter.get('/moderation', (req, res) => {
  ...
  console.log(`[DEBUG /moderation] sessionUserId: ${sessionUserId}`);
  console.log(`[DEBUG /moderation] allLogs count: ${allLogs.length}`);
  if (allLogs.length > 0) {
      console.log(`[DEBUG /moderation] First log ownerId: ${allLogs[0].ownerId}`);
  }
  console.log(`[DEBUG /moderation] filtered logs count: ${logs.length}`);
